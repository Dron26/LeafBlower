...
namespace _1Game.Scripts.Core
{
    public class StageController : MonoBehaviour
    {
        ...
        private List<Vector3> _childrensStartPosition = new List<Vector3>();
        ...
        private void Awake()
        {
            ...
            foreach (Transform transform in this.transform.GetComponentsInChildren<Transform>())
            {
                Vector3 position = transform.localPosition;
                _childrensStartPosition.Add(position);
                _childrens.Add(transform.gameObject);
            }
        ...
        private void SetStartPosition()
        {
            ...
            {
                Vector3 position = _childrensStartPosition[i];
                _childrens[i].transform.localPosition = position;
            }
        }
    }
}